...
def locate_anomaly_mvtec(image_path,iter,save_dir ='./Dinomaly/saved_results',save_name ='vitill_mvtec_uni_dinov2br_c392_en29_bn4dp2_de8_laelu_md2_i1_it10k_sams2e3_wd1e4_w1hcosa2e4_ghmp09f01w01_b16_s1'):
...
if __name__ == '__main__':
    ...
    train(item_list)
    # locate_anomaly_mvtec('000.png',500)
